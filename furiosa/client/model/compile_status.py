...
class CompileStatus(ModelNormal):
    ...
    attribute_map = {
        'compilation_id': 'compilation_id',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, compilation_id, status, *args, **kwargs):  # noqa: E501
        """CompileStatus - a model defined in OpenAPI
